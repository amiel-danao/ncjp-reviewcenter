# Generated by Django 4.1.5 on 2023-01-18 17:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_order', models.CharField(choices=[('content', 'Content'), ('random', 'Random')], default='content', help_text='The order in which multichoice                     answer options are displayed                     to the user', max_length=30, verbose_name='Answer Order')),
            ],
            options={
