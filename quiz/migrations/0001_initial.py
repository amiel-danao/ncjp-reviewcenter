    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.SlugField(allow_unicode=True, help_text='a user friendly url', max_length=60, verbose_name='user friendly url')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='system.course', verbose_name='Course')),
            ],
            options={
                'verbose_name': 'Quiz',
